...
Revision ID: 787167b641fe
Revises: 
Create Date: 2025-06-08 17:07:06.441393
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('GENERAL', 'COMMENT', 'COMMENT_REPLY', 'TASK_ASSIGNMENT', 'PROJECT_INVITE', name='notificationtype'), nullable=False),
