...
def upgrade() -> None:
    ...
    op.add_column('task_comments', sa.Column('parent_comment_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.create_foreign_key(None, 'task_comments', 'task_comments', ['parent_comment_id'], ['id'])
